...
class DeleteSBMethod extends BaseSBMethod
{
    /**
     * @param Order $order
     * @return $this
     */
    public function setRequest($order)
    {
        ...
        $data_order = array(
            ...
            'test_mode' => ConfSB::getConf('test_mode'),
            'order' => array(
                'track_code' => $delivery_info->track_code,
                'delivery_method_code' => $delivery_info->delivery_method_id,
                'salesbeat_order_id' => $delivery_info->salesbeat_order_id
            )
        );
